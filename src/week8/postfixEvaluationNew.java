...
public class postfixEvaluationNew {
...
//         }
   ...
   // create PostFixEvaluation method here
   
   public static String PostfixEvaluation (String a){
         ...
         while (input.hasNext()){
            ...
            if (s.equals("+") || s.equals("-") || s.equals("*") || s.equals("/") || s.equals("^")){
                  ...
                  String result = "(" + operandOne + " " + s + " " + operandTwo + ")";
                  stack.push(result);
            }
            else {
                  stack.push(s);
