...
public class TestDS2023Generics  {
    ...
    public static int progress = 1; // TODO: Change this value as you proceed through parts of the question.
    ...
    CpuInt b = new CpuInt(5).fromInteger(5);
    ...
    ArrayList<CpuInt> aa = VecUtil.arr2vec(new int[]{1,2,3});
    ArrayList<CpuInt> bb = VecUtil.ones(3);
    ...
    public static void testGPU () throws java.lang.Exception
    {
        ...
        GpuInt b = new GpuInt(5).fromInteger(5);
        System.out.println("a = " + a);
        System.out.println("b = " + b);
        System.out.printf("a.toInteger() -> class: %s, value: %d\n",
        a.toInteger().getClass(), a.toInteger());
        ...
        System.out.println("=== GPU Vector constructors and printin ===");
        ArrayList<GpuInt> aa = VecUtil.arr2vec( new int[]{1,2,3});
        ArrayList<GpuInt> bb = VecUtil.ones( 3);
        VecUtil.printVec(aa);
        VecUtil.printVec(bb);
        System.out.println("---");
        if (progress < 3) { 
